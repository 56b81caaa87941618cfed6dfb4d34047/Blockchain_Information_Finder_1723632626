...
*/
Vue.component("simple_footer_component_1723632630", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        © 2023 BlockScan. Empowering users to explore and discover new blockchain information. Stay ahead in the crypto world.
                    </div>
                </div>
            </div>
        </footer> 
